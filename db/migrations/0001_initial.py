# Generated by Django 4.0.3 on 2022-04-10 03:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('event_type', models.IntegerField(verbose_name=[(1, 'Lecture'), (2, 'Lab'), (3, 'Quiz/Continuous Assessment'), (4, 'Examination')])),
        ...
        migrations.AddConstraint(
            model_name='attendancesession',
            constraint=models.UniqueConstraint(fields=('course', 'session', 'start_time', 'stop_time'), name='unique_attendance_session'),
        ),
        migrations.AddConstraint(
            model_name='attendancerecord',
