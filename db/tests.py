...
class FacultyTestCase(TestCase):
    ...
    def test_unique_faculty_constraint(self):
        ...
        self.assertRaises(IntegrityError, Faculty.objects.create, name="engineering")
...
class StaffTitleTestCase(TestCase):
    ...
    def test_unique_title_constraint(self):
        ...
        self.assertRaises(IntegrityError, StaffTitle.objects.create, **{"title":"Prof.", "title_full":"Professor"})
...
class DepartmentTestCase(TestCase):
    def setUp(self):
        ...
        Department.objects.create(name="Electronic Engineering", alias="ECE", faculty=engrng)
    
    def test_unique_department_constraint(self):
        engrng2 = Faculty.objects.create(name="Engineering")
        self.assertRaises(IntegrityError, Department.objects.create, 
                **{"name":"electronic engineering", "alias":"ece", "faculty":engrng2})
    ...
    def test_unique_dept_short_name(self):
        ...
        self.assertRaises(IntegrityError, Department.objects.create,
                **{"name":"elect. engr.", "alias":"ece", "faculty":Faculty.objects.get(name="Physical Sciences")})
...
class StaffTestCase(TestCase):
    ...
    def test_custom_clean(self):
        ...
        dept = Department.objects.create(name="Electronic", alias='ece',
                    faculty=Faculty.objects.create(name="engineering"))
        new_staff = Staff.objects.create_user(email="example@example.com", username="demo_user", 
                    first_name="John", last_name="Doe", other_names="Lorem", 
                    fingerprint_template="77777777",
                    face_encodings="XXXXXXXXX", staff_number="ss.123456", 
                    department=dept)
    ...
    def test_duplicate_staff_number_prevention(self):
        ...
        dept2 = Department.objects.create(name="mathematics", alias='eee',
                    faculty=Faculty.objects.create(name="physical sciences"))
        staff2_dict = {"email":"example2@example.com", "username":"demo_user2", 
                    "first_name":"Jane", "last_name":"Doe", "other_names":"Lorem", 
                    "fingerprint_template":"8888888888",
                    "face_encodings":"YYYYYYYYYY", "staff_number":"ss.123456", 
                    "department":dept2}
        self.assertRaises(ValidationError, Staff.objects.create_user, **staff2_dict)
...
class AcademicSessionTestCase(TestCase):
    def setUp(self):
        AcademicSession.objects.create(session="2019/2020", is_current_session=True)
    ...
    def test_is_current_session_change(self):
        ...
        AcademicSession.objects.create(session="2020/2021", is_current_session=True)
        current_session = AcademicSession.objects.get(is_current_session=True).session
    ...
    def test_duplicate_session_creation(self):
        ...
        self.assertRaises(IntegrityError, AcademicSession.objects.create, **session_details)
...
class AttendanceSessionTestCase(TestCase):
    def test_duplicate_attendance_session_creation(self):
        ...
        staff_obj = Staff.objects.create_user(username="Danladi", first_name="John",
                        last_name="Doe", 
                        email="example@example.com", other_names="Lorem", 
...
class AttendanceRecordTestCase(TestCase):
    ...
    def test_duplicate_att_record_creation(self):
        ...
        record_details = {
                "attendance_session":att_session, "student": student_obj, 
                "record_type": AttendanceRecord.RecordTypes.SIGN_IN 
                }
        self.assertRaises(IntegrityError, AttendanceRecord.objects.create, **record_details)
...
class CourseRegistrationTestCase(TestCase):
    ...
    def test_duplicate_course_reg(self):
        ...
        reg_details = { "session": acad_session, "semester": Semester.SECOND, 
                        "course":course_obj, "student":student_obj}
        self.assertRaises(IntegrityError, CourseRegistration.objects.create, **reg_details)
    ...
    def test_semester_match_validation(self):
        ...
        self.assertRaises(ValidationError, CourseRegistration.objects.create, **reg_details)
